      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <p className="text-center text-gray-500 dark:text-gray-400 text-sm mb-6">
            By signing up, you agree to our <a href="#" className="text-gray-900 dark:text-gray-200">Terms of Service</a> and <a href="#" className="text-gray-900 dark:text-gray-200">Privacy Policy</a>.
          </p>
